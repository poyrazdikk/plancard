...
class DraggablePlanCard:
    ...
    def __init__(
        ...
        y2,
        color="#1f538d",
        text_content="Enter Your Project",
        rect2_coords=None,
        center_coords=None
    ):
        ...
        self.rect2 = canvas.create_rectangle(
            self.r2X1,
            self.r2Y1,
            self.r2X2,
            self.r2Y2,
        ...
        self.textBox_widget = ctk.CTkTextbox(
            self.canvas,
            fg_color=color,
            bg_color=color,
            text_color="#000000",
        ...
        self.textArea = canvas.create_window(
            self.orijin_x,
            self.orijin_y,
            window=self.textBox_widget,
            anchor="center"
        )
